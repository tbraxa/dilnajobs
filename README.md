...
Stuby (jasně označené v kódu i v [docs/STUBS.md](docs/STUBS.md)): SMTP, S3 pokud chybí klíče, Stripe/GoPay checkout, ARES ověření IČO, Sentry pokud chybí `SENTRY_DSN`.

# Copy rules — Czech, vykání, no filler

- Language: **cs-CZ**. Address the reader as **vy**.
...
- Customer-facing copy never mentions checksums, server consoles, local-dev, stubs, env var names, migrations, or database tables. Keep that in `docs/` and operator logs.
